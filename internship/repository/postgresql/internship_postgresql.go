...
func (r *InternshipRepository) Update(internship domain.Internship) error {
	if err := r.db.Save(&internship).Error; err != nil {
		return err
	}
	return nil
}

func (r *InternshipRepository) Delete(internship domain.Internship) error {
	if err := r.db.Delete(&internship).Error; err != nil {
		return err
	}
	return nil
}
